Feature: Manage Products via the Admin UI
    ...
    Scenario: Query Products by Name
        When I visit the "Home Page"
        And I set the "Search Name" to "candy"
        And I press the "Search with Filters" button
        Then I should see the message "Loaded 1 product(s)"
        And I should see "candy" in the results
        And I should see "00001" in the results
        And I should not see "car" in the results
        And I should not see "wood" in the results
        And I should not see "bike" in the results
